...
<head>
    ...
    <title>Şifre Hatırlatma Formu</title>
</head>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Merhaba <?=(($yetkili != "") ? $yetkili : $firmadi)?>,</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Giriş bilgileriniz aşağıda sunulmuştur. Güvenliğiniz İçin Lütfen Kimseyle Paylaşmayınız.</p>
