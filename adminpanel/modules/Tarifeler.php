...
class Tarifeler extends Settings  {

    public $SayfaBaslik = 'Uygulamalar';
    public  $modulName = 'Tarifeler';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'tarifeler';
    private $table = 'tarifeler';
    private $tablelang = 'tarifeler_lang';
    ...
    public function ekle($id=null)
    {
        ...
        $text .= $form->file(array('url'=>$this->BaseURL("upload").'/tarifeler','folder'=>'tarifeler','title'=>'Resim','name'=>'refResim','lang'=>'tr','resimBoyut'=>$this->settings->boyut('refResim'),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
    ...
    public function liste($id=null)
    {
        ...
        return $pagelist->Pagelist(array(
         'title'=> 'Uygulamalar Listesi',
         'page'=>'Tarifeler',
         'button' => array(array('title'=>'Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle.html'),'color'=>'green')),
         'p'=>array(
