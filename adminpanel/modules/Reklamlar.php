...
class Reklamlar extends Settings  {

    public $SayfaBaslik = 'Reklamlar';
    public  $modulName = 'Reklamlar';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'reklamlar';
    private $table = 'reklamlar';
    private $tablelang = 'reklamlar_lang';
    ...
    public function ekle($id=null)
    {
        ...
        $text .= $form->file(array('url'=>$this->BaseURL("upload").'/reklam','folder'=>'reklam','title'=>'Resim','name'=>'refResim','lang'=>'tr','resimBoyut'=>$this->settings->boyut('refResim'),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
