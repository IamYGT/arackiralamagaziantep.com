...
class Kur extends Settings  {

    public $SayfaBaslik = 'Kur';
    public  $modulName = 'Kur';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    ...
    public function ekle($id=null)
    {
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            $tabForm[$dil]['text']  = $form->input(array('value'=>((isset($data[$dil]['firma']) ? $this->temizle($data[$dil]['firma']) :'')),'title'=>'AZN','name'=>'firma','id'=>'firma','help'=>'','lang'=>$dil));
            $tabForm[$dil]['text']  .= $form->input(array('value'=>((isset($data[$dil]['sehir']) ? $this->temizle($data[$dil]['sehir']) :'')),'title'=>'TL','name'=>'sehir','id'=>'sehir','help'=>'','lang'=>$dil));
        endforeach;
    ...
    public function liste($id=null)
    {
        ...
        return $pagelist->Pagelist(array(
            'title'=> 'Kurlar',
            'page'=>'Tarifeler',
            'button' => array(array('title'=>'Kur Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle.html'),'color'=>'green')),
            'p'=>array(
                //array('class'=>'sort','tabindex'=>0,'dataTitle'=>'id'),
            ...
            'baslik'=>array(
                ...
                array('title'=>'AZN','width'=>'1%'),
                array('title'=>'TL','width'=>'50%'),
            )
        ));
    }
