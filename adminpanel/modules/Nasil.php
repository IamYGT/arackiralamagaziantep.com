...
class Nasil extends Settings  {

    public  $SayfaBaslik = 'Nasil';
    public  $modulName = 'Nasil';
    public  $icbaslik ;
    private $js = array();
    private $css = array();
    private $module='nasil';
    private $table ='nasil';
    private $tablelang = 'nasil_lang';
    ...
    {
        $this->icbaslik = 'Nasıl Çalışır Ekle';
        $tabForm = array();
