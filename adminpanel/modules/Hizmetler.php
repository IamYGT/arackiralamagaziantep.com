...
class Hizmetler extends Settings  {

    public $SayfaBaslik = 'Hizmetler';
    public  $modulName = 'Hizmetler';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'hizmetler';
    private $table = 'hizmetler';
    private $tablelang = 'hizmetler_lang';
    ...
    public function ekle($id=null)
    {
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            $tabForm[$dil]['text']  .= $form->input(array('value'=>((isset($data[$dil]['ozet']) ? $this->temizle($data[$dil]['ozet']) :'')),'title'=>'icon','name'=>'ozet','id'=>'ozet','help'=>'','lang'=>$dil));
        ...
        $text .= $form->file(array('url'=>$this->BaseURL("upload").'/hizmetler','folder'=>'hizmetler','title'=>'Resim','name'=>'refResim','lang'=>'tr','resimBoyut'=>$this->settings->boyut('refResim'),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
    ...
    public function fotoekle($id=0)
    {
        ...
        return $pagelist->Fotolist(array(
            ...
            'buton'=> array(/*array('type'=>'radio','dataname'=>'durum','url'=>$this->BaseAdminURL($this->modulName.'/durum/')),*/),
