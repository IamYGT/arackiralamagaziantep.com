...
class Etkinlikler extends Settings  {

    public $SayfaBaslik = 'Etkinlikler';
    public  $modulName = 'Etkinlikler';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'etkinlikler';
    private $table = 'etkinlikler';
    private $tablelang = 'etkinlikler_lang';
    ...
    public function ekle($id=null)
    {
        ...
        $text .= $form->file(array('url'=>$this->BaseURL("upload").'/etkinlik','folder'=>'etkinlik','title'=>'Resim','name'=>'refResim','lang'=>'tr','resimBoyut'=>$this->settings->boyut('refResim'),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
