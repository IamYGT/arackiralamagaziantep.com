...
class Sigorta extends Settings  {

    public $SayfaBaslik = 'Sigorta';
    public  $modulName = 'Sigorta';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'sigorta';
    private $table = 'sigorta';
    private $tablelang = 'sigorta_lang';
    ...
    public function ekle($id=null)
    {
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            $tabForm[$dil]['text']  = $form->input(array('value'=>((isset($data[$dil]['ozet']) ? $this->temizle($data[$dil]['ozet']) :'')),'title'=>'Beden Value','name'=>'ozet','id'=>'ozet','help'=>' ( evet / hayır ) bu Şekilde Yazısınız. ','lang'=>$dil));
