...
class neDediler extends Settings  {

    public $SayfaBaslik = 'Ne Dediler';
    public  $modulName = 'neDediler';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $module = 'nedediler';
    private $table = 'nedediler';
    private $tablelang = 'nedediler_lang';
    ...
    public function liste($id=null)
    {
      ...
      return $pagelist->Pagelist(array(
         ...
         'p'=>array(
                      ...
                      array('dataTitle'=>'gonderen', 'class'=>'sort')
                  ),
