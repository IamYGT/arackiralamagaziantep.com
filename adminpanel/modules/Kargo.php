...
class Kargo extends Settings  {

    public $SayfaBaslik = 'Kargo Bilgilendirme';
    public  $modulName = 'Kargo';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'kargo';
    private $table = 'kargo';
    private $tablelang = 'kargo_lang';
    ...
    public function ekle($id=null)
    {
        ...
        $this->icbaslik = 'Bilgilendirme Ekle';
        $tabForm = array();
        ...
        foreach ($this->settings->lang('lang') as $dil=>$title):
            ...
            $tabForm[$dil]['text']  .= $form->input(array('value'=>((isset($data[$dil]['detay']) ? $this->temizle($data[$dil]['detay']) :'')),'title'=>'Ürün Adeti','name'=>'detay','id'=>'detay','help'=>'','lang'=>$dil));
            $tabForm[$dil]['text']  .= $form->input(array('value'=>((isset($data[$dil]['ozet']) ? $this->temizle($data[$dil]['ozet']) :'')),'title'=>'Ürün Fiyatı','name'=>'ozet','id'=>'ozet','help'=>'','lang'=>$dil));
        endforeach;
    ...
    public function liste($id=null)
    {
        ...
        return $pagelist->Pagelist(array(
         'title'=> 'Bilgilendirme Listesi',
         'page'=>'Kargo',
         'button' => array(array('title'=>'Bilgilendirme Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle.html'),'color'=>'green')),
         'p'=>array(
         ...
         'pdata' => $this->dbConn->sorgu('select * from '.$this->table.' ORDER   BY  sira,id ASC'),
