...
class Tamam extends Settings  {

    public $SayfaBaslik = 'Tamamlanan Projeler';
    public  $modulName = 'Tamam';
    public $icbaslik ;
    private $js = array();
    private $css = array();
    private $siteURL;
    private $set;
    private $module = 'tamam';
    private $table = 'tamam';
    private $tablelang = 'tamam_lang';
    ...
    public function ekle($id=null)
    {
        ...
        $text .= $form->file(array('url'=>$this->BaseURL("upload").'/devam-eden','folder'=>'devam-eden','title'=>'Resim','name'=>'refResim','lang'=>'tr','resimBoyut'=>$this->settings->boyut('refResim'),'src'=>((isset($data['tr']['resim'])) ? $data['tr']['resim'] :'')));
    ...
    public function liste($id=null)
    {
        ...
        return $pagelist->Pagelist(array(
         'title'=> 'Proje Listesi',
         'page'=>'Tarifeler',
         'button' => array(array('title'=>'Proje Ekle','href'=>$this->BaseAdminURL($this->modulName.'/ekle.html'),'color'=>'green')),
         'p'=>array(
